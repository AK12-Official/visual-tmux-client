...
- **WHEN** a caller requests session creation with a name containing characters outside the permitted set, or exceeding the permitted length
...
- **THEN** the hub rejects the name at validation and no shell interpretation of it ever occurs
